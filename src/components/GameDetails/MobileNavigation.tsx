...
export function MobileNavigation({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <SheetContent
        side="left"
        className="w-[280px] sm:w-[320px] bg-[#1e1e2e] border-ctp-surface1 z-[100] overflow-y-auto"
      >
          ...
          <div className="px-2">
            ...
            <nav className="flex flex-col gap-1">
              ...
              <PrefetchLink
                ...
                style={
                  currentPath === "/" ? { borderLeft: "3px solid #89b4fa" } : {}
                }
              >
              ...
              >
                <Trophy
                  ...
                  style={{
                    color: currentPath.startsWith("/leaderboards")
                      ? "#f9e2af"
                      : "#cdd6f4",
                  }}
                />
              ...
              >
                <Upload
                  className="h-4 w-4 flex-shrink-0"
                  style={{
                    color: currentPath.startsWith("/submit")
                      ? "#a6e3a1"
                      : "#cdd6f4",
                  }}
                />
                ...
                sortedHeaderLinks.map((link) => {
                  ...
                  return (
                    <PrefetchLink
                      ...
                      style={
                        isActive ? { borderLeft: `3px solid ${linkColor}` } : {}
                      }
                    >
                      {IconComponent &&
                        (link.icon === "LegoStud" ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                {hasNotifications && (
                  <Button
                    ...
                    title={
                      currentUser.isAdmin
                        ? t("components.runsWaitingForVerification", {
                            count: notificationCount,
                          })
                        : t("components.unclaimedRunsCount", {
                            count: notificationCount,
                          })
                    }
                  >
                    ...
                    <span className="flex-1 text-left">
                      {currentUser.isAdmin
                        ? t("components.verifyRuns")
                        : t("components.claimRuns")}
                    </span>
                    <Badge
                      variant="destructive"
