...
import {
  getDownloadEntriesFirestore as getDownloadEntries,
  getDownloadCategoriesFirestore as getDownloadCategories,
} from "@/lib/data/firestore/downloads";
