        ...
        <Tabs value={leaderboardType} onValueChange={(value) => setLeaderboardType(value as 'regular' | 'individual-level' | 'community-golds')} className="mb-6">
          ...
          <CardContent className="p-5">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold mb-2 text-[hsl(220,17%,92%)]">Run Type</label>
              ...
              <div>
                <label className="block text-sm font-semibold mb-2 text-[hsl(220,17%,92%)]">Run Status</label>
